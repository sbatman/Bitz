...
namespace Bitz
{
	...
	{
		/// <summary>
		///     The Packet class is a light class that is used for serialising data into and from the any byte
		///     stream/array. This allows easy passing over variables over a network or storage medium and guarantees order.
		/// </summary>
		class Packet
		{
		public:
